...
"""
 ...
 TO DO: 
[]	Implement the listing into a tex document
[]	Compile the tex document into a pdf, with clickable links
[]	Save the files into Zotero, through the Arxiv metadata	
...
[]			+If this is the case then I might want to implement the class in C++
